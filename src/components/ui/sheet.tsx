 ...
 * same one button.tsx carries: the close control does not draw its own focus
 * ring, because this site has a single `:focus-visible` outline in global.css
 * that every control shares. It is also sized to a 44px touch target, which
 * upstream's bare 16px icon is not.
 */
